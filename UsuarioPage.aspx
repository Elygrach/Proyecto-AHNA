<%@ Page Title="Usuario" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsuarioPage.aspx.cs" Inherits="Proyecto_AHNA.UsuarioPage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="container">
    ...
    <input type="text" id="username" name="username" placeholder="Ingresa tu usuario"
           style="text-align: center; background-image: url('resources/perm_identity_24dp_5F6368.png'); background-repeat: no-repeat; background-size: 30px 30px; background-position: 10px center; padding-left: 40px; min-height: 40px; width: 100%; max-width: 300px;">
      </div>
        ...
        <button type="submit" style="display: block; margin: 20px auto;" class="btn btn-primary">Ingresar</button>
    </form>
</div>
